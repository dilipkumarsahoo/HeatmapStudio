      ...
      <section className="pt-32 pb-20 relative">
        ...
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-xl text-foreground/60 max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
            HeatMap Studios was founded with a simple mission: to create a
            unified ecosystem of tools that empower individuals to reach their
            full potential without the clutter.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-12">
          {[
            ...
            <div key={i} className="text-center">
              ...
              <p className="text-sm text-foreground/50 uppercase tracking-widest font-semibold">
                {stat.label}
              </p>
            </div>
          ))}
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-foreground/60 max-w-xl mx-auto">
              We believe in quality over quantity, precision over speed, and
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="p-10 rounded-[32px] border border-foreground/5 hover:border-foreground/10 transition-all hover:shadow-xl group"
              >
                <div
                  className={`w-12 h-12 rounded-2xl ${value.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}
                >
                  {value.icon}
                </div>
