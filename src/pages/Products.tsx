    ...
    <main className="min-h-screen bg-background font-sans overflow-x-hidden">
      ...
      <div className="pt-24 pb-12">
        <div className="max-w-[1200px] mx-auto px-6 text-center mb-16 animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out">
          ...
          <p className="text-lg sm:text-xl text-foreground/60 max-w-2xl mx-auto leading-relaxed">
            Our ecosystem is designed to remove friction from your workflow,
            allowing you to focus on what truly matters: your growth.
          </p>
        </div>
      ...
      <section className="bg-foreground py-20 mt-10">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <h2 className="text-white font-display text-3xl md:text-5xl font-medium mb-12">
            Join 10k+ professionals using HeatMap Studios
          </h2>
          <div className="flex flex-wrap justify-center gap-12">
            {[
              ...
              <div key={stat.label} className="text-center">
                <p className="text-brand-green font-display text-4xl font-bold mb-2">
                  {stat.value}
                </p>
