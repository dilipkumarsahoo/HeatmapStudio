  ...
  return (
    <section className="bg-background py-20" id="products">
      ...
      <div className="max-w-[1200px] mx-auto  px-6 space-y-6">
        {/* Sky card */}
        <div className="bg-sky-200 rounded-3xl p-10 md:p-14 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-foreground/70 text-sm max-w-md leading-relaxed">
              Improve your typing speed and accuracy with engaging practice
              sessions, real-time WPM tracking, and a distraction-free
              experience designed to build confidence every day.
            </p>

            <div className="mt-8">
              <a
                href="https://typekaro.heatmapstudios.com/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-foreground text-background text-xs font-bold px-6 py-3 rounded-full"
              >
                Try Typekaro ↗
              </a>
            </div>
          ...
          <div className="bg-background rounded-2xl p-6 shadow-xl max-w-sm ml-auto">
            <div className="overflow-hidden rounded-xl h-64">
              <img
                src="/images/typekaro-preview.png"
                alt="Typekaro Typing Practice Preview"
        ...
        {/* Orange card */}
        <div className="bg-orange-200 rounded-3xl p-10 md:p-14 grid md:grid-cols-2 gap-8 items-center">
          <div className="bg-background rounded-2xl p-6 shadow-xl max-w-sm">
            <div className="overflow-hidden rounded-xl h-64">
              <img
                src="/images/focus-preview.png"
                alt="FocusTimer App Preview"
                className="w-full h-full object-cover rounded-xl"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-foreground/70 text-sm max-w-md leading-relaxed">
              Boost concentration using Pomodoro sessions, distraction blocking,
              and insightful productivity reports.
            </p>

            <div className="mt-8">
              <a
                href="https://piko.heatmapstudios.com/"
                target="_blank"
                className="inline-block bg-foreground text-background text-xs font-bold px-6 py-3 rounded-full"
              >
                Start Focusing ↗
        ...
        {/* Green card */}
        <div className="bg-brand-green rounded-3xl p-10 md:p-14 grid md:grid-cols-2 gap-8 items-center">
          <div className="bg-background rounded-2xl p-6 shadow-xl max-w-sm">
            ...
            <p className="font-bold text-foreground mb-1 text-sm tracking-tight">
              Dr.Doc
            </p>
            ...
            <div className="overflow-hidden rounded-xl h-auto -mt-10 -mb-10">
              <img
                src="/images/drdoc-preview.png"
                alt="Drdoc App Preview"
                className="w-full h-full object-cover rounded-xl"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-foreground/70 text-sm max-w-md leading-relaxed">
              Transform paper documents into searchable PDFs with built-in OCR.
              Scan receipts, invoices, contracts, notes, and more in seconds
              while keeping everything securely organized and easy to access.
            </p>

            <div className="mt-8">
              <a
                href="https://drdoc.heatmapstudios.com/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-foreground text-background text-xs font-bold px-6 py-3 rounded-full"
              >
                Explore Smart Scanner ↗
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="bg-brand-yellow rounded-3xl p-10 md:p-14 grid md:grid-cols-2 gap-8 items-center animate-in fade-in slide-in-from-bottom-10 duration-1000">
          <div>
            ...
            <p className="text-foreground/70 text-sm max-w-md">
              Capture thoughts, draft projects, and organize ideas as they
              happen. A minimalist interface that removes the noise, allowing
              you to focus on what matters most.
            </p>
            <div className="mt-8">
              <a
                href="https://inkdrop-web.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-foreground text-background text-xs font-bold px-6 py-3 rounded-full"
              >
          ...
          <div className="relative">
            <div className="bg-background rounded-2xl p-6 shadow-xl max-w-sm">
              ...
              <div className="overflow-hidden rounded-xl ">
                <img
                  src="/images/inkdrop-preview.png"
                  alt="Inkdrop App Preview"
                  className="w-full h-auto object-cover rounded-xl"
                />
              </div>
            </div>
            <div className="absolute -left-20 top-10 bg-foreground rounded-2xl p-4 w-48 shadow-xl">
        ...
        {/* Pink card */}
        <div className="bg-brand-pink rounded-3xl p-10 md:p-14 grid md:grid-cols-2 gap-8 items-center animate-in fade-in slide-in-from-bottom-10 duration-1000">
          <div className="bg-background rounded-2xl p-6 shadow-xl max-w-sm">
            <div className="flex items-center gap-1.5 mb-6">
              <span className="w-2 h-2 rounded-full bg-red-400" />
              <span className="w-2 h-2 rounded-full bg-yellow-400" />
            ...
            <p className="text-foreground/50 text-xs">
              Wake up with purpose every day.
            </p>

            <div className="overflow-hidden rounded-xl -mt-20">
              <img
                src="/images/qrise-preview.png"
                alt="QRise App Preview"
                className="w-full h-auto object-cover rounded-xl"
              />
            </div>
          </div>
          <div>
            ...
            <p className="text-foreground/70 text-sm max-w-md leading-relaxed">
              QRise helps you beat snoozing, build better habits, and start
              every day focused, energized, and productive. Turn your mornings
              into a routine that keeps you motivated from the moment you wake
              up.
            </p>

            <div className="mt-8">
              <a
                href="https://qrise.heatmapstudios.com/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-foreground text-background text-xs font-bold px-6 py-3 rounded-full"
              >
        ...
        <div className="bg-brand-purple rounded-3xl p-10 md:p-14 grid md:grid-cols-2 gap-8 items-center animate-in fade-in slide-in-from-bottom-10 duration-1000">
          <div className="bg-background rounded-2xl p-6 shadow-xl max-w-sm">
            ...
            <div className="overflow-hidden rounded-xl ">
              <img
                src="/images/pennypilot-preview.png"
                alt="PennyPilot App Preview"
                className="w-full h-auto object-cover rounded-xl"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-foreground/70 text-sm max-w-md leading-relaxed">
              PennyPilot helps you track expenses, monitor your budget, and gain
              insights into your spending habits. Stay on top of your finances
              and make smarter money decisions every day.
            </p>

            <div className="mt-8">
              <a
                href="https://pennypilot.heatmapstudios.com/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block bg-foreground text-background text-xs font-bold px-6 py-3 rounded-full"
              >
      ...
      <div className="max-w-[1200px] mx-auto px-6 mt-5 animate-in fade-in slide-in-from-bottom-10 duration-1000">
        <div className="bg-[#58A37C] rounded-[40px] px-10 py-16 md:p-20 grid md:grid-cols-2 gap-12 items-center overflow-hidden">
            ...
            <div className="bg-white rounded-[32px] p-6 shadow-2xl relative z-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative aspect-[4/5] rounded-2xl bg-foreground overflow-hidden p-4 shadow-inner">
                  <p className="text-[10px] text-white/40 mb-2 uppercase tracking-tight">
                    Preview Mode
                  </p>
              ...
              <div className="absolute -bottom-6 -right-2 sm:-bottom-8 sm:right-6 bg-white rounded-2xl p-4 sm:p-5 shadow-2xl w-48 sm:w-56 z-20 border border-foreground/5 scale-90 sm:scale-100 origin-bottom-right">
                ...
                <p className="text-[10px] text-black/50 leading-relaxed mb-4">
                  98% compatibility with modern HR software.
                </p>
          ...
          <div className="text-white">
            ...
            <p className="text-lg text-white/70 max-w-sm leading-relaxed">
              Craft professional, ATS-ready resumes in minutes. Focus on your
              achievements while we handle the design to make you stand out.
            </p>
            <div className="mt-8">
              <a
                href="https://qrise.heatmapstudios.com/"
