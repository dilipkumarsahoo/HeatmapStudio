  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-background/80 backdrop-blur-lg border-b border-foreground/5 py-3"
          : "bg-transparent py-5"
      }`}
    >
      <div className="max-w-[1200px] mx-auto px-6 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-1 z-50">
          ...
          <span className="font-display text-2xl font-bold text-foreground tracking-tight">
            HeatMap
            <span className="text-foreground/40 font-medium">Studios</span>
          </span>
        </Link>
        ...
        <div className="flex items-center gap-2 sm:gap-3 z-50">
          {/* <button className="hidden lg:block text-sm font-medium text-foreground hover:opacity-70">
            Book A Demo
          </button> */}
          ...
          <Link
            to="/products"
            className="hidden sm:block bg-foreground text-background text-sm font-medium px-5 py-2.5 rounded-full hover:opacity-90 transition-all active:scale-95 text-center"
          >
            Get Started
          </Link>
      ...
      >
        ...
        >
          ...
          <Link
            to="/products"
            onClick={() => setIsMobileMenuOpen(false)}
            className="w-full block text-center bg-foreground text-background text-lg font-bold py-5 rounded-2xl shadow-lg"
          >
            Get Started
          </Link>
        </div>
