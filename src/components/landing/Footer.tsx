      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center gap-4">
            <Link
              to="/products"
              className="bg-white text-black font-medium px-8 py-3.5 rounded-full hover:bg-white/90 transition-colors"
            >
              Explore Tools
            </Link>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between border-t border-gray-100 pt-10 pb-6">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display text-2xl font-bold tracking-tight text-[#111]">
                HeatMap Studios
              </span>
            </div>
            <div className="flex items-center gap-6">
              ...
              >
                <Linkedin size={20} fill="#111" strokeWidth={0} />
              </a>
              <a
                href="#"
                className="text-foreground hover:opacity-70 transition-opacity"
              ...
              <a
                ...
                className="text-foreground hover:opacity-70 transition-opacity"
              >
                <Facebook size={20} fill="#111" strokeWidth={0} />
              </a>
              <a
                href="#"
                className="text-foreground hover:opacity-70 transition-opacity"
              >
                <Youtube size={20} fill="#111" strokeWidth={0} />
              </a>
              <a
                href="#"
                className="text-foreground hover:opacity-70 transition-opacity"
              >
                <Twitter size={20} fill="#111" strokeWidth={0} />
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mt-6 text-sm text-foreground/60">
          <p>© 2026 HeatMap Studios. Tools for the way you move.</p>
